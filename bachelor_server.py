...
This Script works as the host Computer for the force sensing book. It sends informational data to the console
 and reads commands from the dialog-window if the user presses "ok". The Scripts receives data sent from the Book and 
 collects it.
 

"""
data_folder = "X" # Work-Folder

data = ''
hx_databank = [] # [hx_seqnum, hx_t_now, hx_raw_value, hx_scale_offset, hx_i, hx_value]
hx_book_databank = [] # [recent_sensor_value_list[0][1], grid_weight, tilt_weight, 0.0, 0.0]
imu_databank = [] # [ float(tnow), xAc, yAc,zAc, (x_gy), (y_gy),  (z_gy)]
int_imu = 0
int_hx = 0
command = ''
# Other IP
...
"""
Reads data from arduino and reacts to User commands
"""
